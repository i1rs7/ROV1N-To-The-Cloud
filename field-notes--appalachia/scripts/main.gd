...
@onready var robo_cam: Camera3D = $Player/third_p_controller/Robot/Head/SpringArm3D/RoboCam
@onready var robot: Node3D = $Player/third_p_controller/Robot
@onready var cam_ui: Control = $Player/third_p_controller/CamUI
@onready var head: Node3D = $Player/third_p_controller/Robot/Head
@onready var zoom_label: Label = $Player/third_p_controller/CamUI/ZoomLabel
